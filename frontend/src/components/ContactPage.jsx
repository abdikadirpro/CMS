...
/**
 * Shared Contact-page layout for the Ethics and Membership portals — same static-info-card +
 * form pattern as the original main-site Contact.jsx, parameterized per portal. No backend
 * email-sending is wired up (matches the original page's placeholder toast-only submit).
 */
export default function ContactPage({ title, description, email, phone, location }) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-2 text-[rgb(var(--fg-muted))]">{description}</p>
